...
\begin{table}[H]
\centering
\caption{Forward, tasa SOFR e implícita en pesos (2026)\footnotemark}
\scriptsize
\renewcommand{\arraystretch}{1.2}
...
\textit{sep-26} & \textit{3.834} & \textit{3,56\%} & \textit{11,16\%} \\
\textit{oct-26} & \textit{3.861} & \textit{3,52\%} & \textit{11,26\%} \\
\textit{nov-26} & \textit{3.888} & \textit{3,49\%} & \textit{11,36\%} \\
dic-26 & 3.932 & 3,46\% & 11,46\% \\

\bottomrule
\end{tabular}
\end{table}
\footnotetext{Filas en \textit{itálica} representan las tasas implícitas interpoladas a través del proceso descrito.}
...
(Valores en MM COP, a excepción de precio fwd y tasa libre de riesgo.)
\footnotesize
\renewcommand{\arraystretch}{1.2}

\begin{tabular}{l|rrrr|r}
\hline
\textbf{Mes} & \textbf{Flujo estrategia} & \textbf{Costo variable} & \textbf{Costo fijo} & \textbf{Utilidad} & \textbf{Utilidad en VP\footnotemark} \\

\hline
feb-26 & -0,49 & - & 14,70 & -15,19 &  -15,19 \\
mar-26 & - & - & 14,70 & -14,70 &  -14,56 \\
abr-26 & 58,21 & 8,00 & 14,70 & 35,51 & 34,84 \\
may-26 & - & - & 14,70 & -14,70 & -14,27 \\
jun-26 & 83,66 & 11,25 & 14,70 & 57,71  & 55,44 \\
jul-26 & - & - & 14,70 & -14,70 & -13,98 \\
ago-26 & 66,53 & 8,75 & 14,70 & 43,08 & 40,55 \\
sep-26 & - & - & 14,70 & -14,70 & -13,71 \\
oct-26 & 72,40 & 9,25 & 14,70 & 48,54 & 44,71 \\
nov-26 & - & - & 14,70 & -14,70 & -13,43 \\
dic-26 & 61,15 & 7,50 & 14,70 & 38,95 & 35,22 \\
\hline
\textbf{Total} & \textbf{341,56} & \textbf{44,75} & \textbf{161,70} & \textbf{135,11}   & \textbf{125,62} \\
\hline
\end{tabular}
\end{table}
...
De esta manera, se concluye que, el valor certero en pesos de la utilidad en valor presente al 13 de febrero del 2026 es de: COP 125.624.239.911,13.
    ...
    Una vez calculados los par\'ametros $u$ y $d$ se calculo el arbol binomial para la acci\'on de Booble.

    
 
    \subsection{Valoraci\'on opci\'on put americana}

    \input{output/arbol_precios}
